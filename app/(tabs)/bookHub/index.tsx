...
import BookHubPost from "@/components/BookHubPost";
import EmptyStatePost from "@/components/EmptyStatePost";
        ...
        <FlatList<Post>
          ...
          ListEmptyComponent={() => (
            <EmptyStatePost
              ...
              subtitle={"No posts available at the moment"}
            />
          )}
          refreshControl={
