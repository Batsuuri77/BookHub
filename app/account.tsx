        ...
        <View style={styles.container}>
          <View style={styles.profileContainer}>
            ...
            <TouchableOpacity onPress={handleChangeProfilePicture}>
              <Text style={styles.changeProfilePic}>Change Profile Picture</Text>
            </TouchableOpacity>
          </View>
...
function launchImageLibrary(options: { mediaType: string; includeBase64: boolean; }, arg1: (response: any) => void) {
